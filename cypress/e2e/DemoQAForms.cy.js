  ...
  it('Fill Forms', () => {
    ...
    cy.fixture('xlsxData.json').then((formData) => {
      ...
      formData.forEach(data => {
        ...
        form_Page.fillForms(data.rows.firstName, data.rows.lastName, data.rows.email,
          data.rows.telephonNo, data.rows.subject, data.rows.dob, data.rows.current_address, data.rows.photoPath)
